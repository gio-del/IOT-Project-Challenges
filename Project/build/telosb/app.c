...
typedef nx_struct pub_sub_msg {
  ...
  nx_uint8_t topic;
  nx_uint16_t payload;
} __attribute__((packed)) pub_sub_msg_t;
...
typedef client_info_t client_list_t[20];
...
typedef TMilli LightPubSubC__Timer0__precision_tag;
typedef TMilli LightPubSubC__Timer3__precision_tag;
typedef TMilli LightPubSubC__Timer1__precision_tag;
typedef TMilli LightPubSubC__Timer2__precision_tag;
...
static void LightPubSubC__Timer0__fired(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static void LightPubSubC__AMControl__startDone(error_t error);
#line 138
static void LightPubSubC__AMControl__stopDone(error_t error);
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void LightPubSubC__Boot__booted(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void LightPubSubC__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LightPubSubC__Timer3__fired(void );
#line 83
static void LightPubSubC__Timer1__fired(void );
...
LightPubSubC__Receive__receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LightPubSubC__Timer2__fired(void );
...
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static void /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 96
message_t * msg, 
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static bool LightPubSubC__Timer0__isRunning(void );
#line 73
static void LightPubSubC__Timer0__startOneShot(uint32_t dt);
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t LightPubSubC__AMControl__start(void );
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static error_t LightPubSubC__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
LightPubSubC__Packet__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LightPubSubC__Timer3__startOneShot(uint32_t dt);
#line 73
static void LightPubSubC__Timer1__startOneShot(uint32_t dt);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t LightPubSubC__Random__rand16(void );
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void LightPubSubC__Timer2__startOneShot(uint32_t dt);
# 25 "LightPubSubC.nc"
message_t LightPubSubC__packet;

message_t LightPubSubC__queued_packet;
uint16_t LightPubSubC__queued_address;
bool LightPubSubC__locked;


bool LightPubSubC__connectAcked;
bool LightPubSubC__subscribeAcked;
...
#line 36
typedef struct LightPubSubC__message_list {
  pub_sub_msg_t msg;
  uint16_t destination;
  struct LightPubSubC__message_list *next;
} LightPubSubC__message_list_t;

client_list_t LightPubSubC__client_list;
LightPubSubC__message_list_t *LightPubSubC__message_list = (void *)0;


static void LightPubSubC__add_message(LightPubSubC__message_list_t **list, pub_sub_msg_t msg, uint16_t destination);
static inline uint16_t LightPubSubC__pop_message(LightPubSubC__message_list_t **list, pub_sub_msg_t *message);
static inline bool LightPubSubC__is_empty_message_list(LightPubSubC__message_list_t **list);


static bool LightPubSubC__generate_send(uint16_t address, message_t *msg);
static inline bool LightPubSubC__actual_send(uint16_t address, message_t *msg);
static inline void LightPubSubC__initClientList(void );

static inline void LightPubSubC__handleConnect(pub_sub_msg_t *msg);
static inline void LightPubSubC__handleConnectAck(pub_sub_msg_t *msg);
static inline void LightPubSubC__handleSubscribe(pub_sub_msg_t *msg);
static inline void LightPubSubC__handleSubscribeAck(pub_sub_msg_t *msg);
static inline void LightPubSubC__handlePublish(pub_sub_msg_t *msg);
static inline void LightPubSubC__addClientMatchingTopic(client_list_t client_list, pub_sub_msg_t msg);
...
static inline void LightPubSubC__Timer0__fired(void );
...
static inline void LightPubSubC__Timer1__fired(void );
#line 98
static inline void LightPubSubC__Timer2__fired(void );
#line 119
static inline void LightPubSubC__Timer3__fired(void );
#line 146
static inline bool LightPubSubC__actual_send(uint16_t address, message_t *msg);
#line 164
static inline void LightPubSubC__Boot__booted(void );



static inline void LightPubSubC__AMControl__startDone(error_t err);
#line 187
static inline void LightPubSubC__AMControl__stopDone(error_t err);

static void LightPubSubC__AMSend__sendDone(message_t *bufPtr, error_t error);
...
static inline message_t *LightPubSubC__Receive__receive(message_t *bufPtr, void *payload, uint8_t len);
#line 223
static inline void LightPubSubC__handleConnect(pub_sub_msg_t *msg);
#line 235
static inline void LightPubSubC__handleConnectAck(pub_sub_msg_t *msg);
...
message_t *msg);
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
static void /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
static error_t /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 67
message_t * msg, 
...
static void /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 158
message_t * amsg, 
...
static inline error_t /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 39 "/opt/tinyos-main-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0xb7937b30){
#line 39
  switch (arg_0xb7937b30) {
#line 39
    case 0:
#line 39
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0xb7937b30);
#line 39
      break;
#line 39
    }
...
# 88 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0xb6efb148, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0xb6efb148, msg);
#line 88
}
#line 88
...
# 128 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0xb73a3f08){
#line 128
  unsigned char __nesc_result;
#line 128

#line 128
  switch (arg_0xb73a3f08) {
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0xb73a3f08);
#line 128
      break;
#line 128
    }
...
# 39 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0xb73a2970){
#line 39
  union __nesc_unnamed4284 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0xb73a2970);
#line 39
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0xb728ccf8){
#line 59
  switch (arg_0xb728ccf8) {
#line 59
...
#line 59
    default:
#line 59
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0xb728ccf8);
#line 59
      break;
#line 59
    }
...
# 61 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0xb728d948){
#line 61
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0xb728d948);
#line 61
}
#line 61
...
# 97 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0xb73a3f08){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0xb73a3f08);
#line 97
      break;
#line 97
    }
...
# 53 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0xb728d948){
#line 53
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0xb728d948);
#line 53
}
#line 53
...
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0xb73a3f08){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0xb73a3f08);
#line 88
      break;
#line 88
    }
...
# 65 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0xb728ccf8){
#line 65
  switch (arg_0xb728ccf8) {
#line 65
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 65
    default:
#line 65
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0xb728ccf8);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0xb73a3f08){
#line 120
  unsigned char __nesc_result;
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0xb73a3f08);
#line 120
      break;
#line 120
    }
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0xb6d3e420, message_t * msg, error_t error){
#line 110
    /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__default__sendDone(arg_0xb6d3e420, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0xb6c8fc60, message_t * msg, error_t error){
#line 100
  switch (arg_0xb6c8fc60) {
#line 100
...
#line 100
    default:
#line 100
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0xb6c8fc60, msg, error);
#line 100
      break;
#line 100
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0xb6d3ede0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0xb6d3ede0, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0xb6c8f620, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb6c8f620) {
#line 78
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0xb6c8f620, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 31 "/opt/tinyos-main-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0xb6c8c770, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31

#line 31
  switch (arg_0xb6c8c770) {
#line 31
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0xb6c8c770, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0xb6c8c770){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0xb6c8c770);
#line 15
      break;
#line 15
    }
...
# 65 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0xb728ccf8){
#line 65
  switch (arg_0xb728ccf8) {
#line 65
...
#line 65
    default:
#line 65
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0xb728ccf8);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0xb6e1f010){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0xb6e1f010) {
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0xb6e1f010);
#line 120
      break;
#line 120
    }
...
# 128 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0xb6e1f010){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0xb6e1f010);
#line 128
      break;
#line 128
    }
...
# 97 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0xb6e1f010){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0xb6e1f010);
#line 97
      break;
#line 97
    }
...
# 61 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0xb728d948){
#line 61
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0xb728d948);
#line 61
}
#line 61
...
# 39 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0xb6e1fa68){
#line 39
  union __nesc_unnamed4288 *__nesc_result;
#line 39

#line 39
  switch (arg_0xb6e1fa68) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0xb6e1fa68);
#line 39
      break;
#line 39
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0xb6e24910){
#line 102
  switch (arg_0xb6e24910) {
#line 102
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0xb6e24910);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0xb7290e78){
#line 102
  switch (arg_0xb7290e78) {
#line 102
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0xb7290e78);
#line 102
      break;
#line 102
    }
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0xb728ccf8){
#line 59
  switch (arg_0xb728ccf8) {
#line 59
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 59
    default:
#line 59
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0xb728ccf8);
#line 59
      break;
#line 59
    }
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  LightPubSubC__AMSend__sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0xb6e8bc98, message_t * msg, error_t error){
#line 100
  switch (arg_0xb6e8bc98) {
#line 100
    case 0U:
#line 100
      /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0xb6e8bc98, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0xb6e87730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0xb6e87730, addr, msg, len);
#line 80
...
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0xb6efca98, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0xb6efca98, dest, msg);
#line 59
}
#line 59
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0xb6efb148, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0xb6efb148, msg);
#line 95
}
#line 95
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0xb6f4f628){
#line 102
  switch (arg_0xb6f4f628) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0xb6f4f628);
#line 102
      break;
#line 102
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
inline static void /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
# 103 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
#line 55
{
  /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 6);
  return /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t LightPubSubC__AMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*LightPubSubAppC.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
inline static void * LightPubSubC__Packet__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
#line 146
{
  if (LightPubSubC__locked == TRUE) {
      printf("Sending Message: Locked\n");
      return FALSE;
    }
  else {
      pub_sub_msg_t *psm = (pub_sub_msg_t *)LightPubSubC__Packet__getPayload(msg, sizeof(pub_sub_msg_t ));

#line 153
      if (LightPubSubC__AMSend__send(address, msg, sizeof(pub_sub_msg_t )) == SUCCESS) {
          printf("Packet passed to lower layer");
          printf(" -Dest: %d", address);
          printf(" -Type: %d (0 = CONN, 1 = CONNACK, 2 = SUB, 3 = SUBACK, 4 = PUB)\n", __nesc_ntoh_uint8(psm->type.nxdata));
          LightPubSubC__locked = TRUE;
          return TRUE;
        }
    }
  return FALSE;
...
#line 73
{
  LightPubSubC__actual_send(LightPubSubC__queued_address, &LightPubSubC__queued_packet);
}

# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void LightPubSubC__Timer1__startOneShot(uint32_t dt){
#line 73
...
#line 317
{
  if (LightPubSubC__is_empty_message_list(list)) {
      return 0;
    }
  else 
#line 320
    {
      LightPubSubC__message_list_t *current = *list;
...
#line 80
{
  if (LightPubSubC__is_empty_message_list(&LightPubSubC__message_list) == TRUE) {
      LightPubSubC__Timer1__startOneShot(300);
      return;
    }
  else 
#line 84
    {
      pub_sub_msg_t msg;
      uint16_t destination = LightPubSubC__pop_message(&LightPubSubC__message_list, &msg);
      pub_sub_msg_t *payload = (pub_sub_msg_t *)LightPubSubC__Packet__getPayload(&LightPubSubC__packet, sizeof(pub_sub_msg_t ));

#line 88
      printf("PAN Coordinator has a message to send\n");
      *payload = msg;
      LightPubSubC__generate_send(destination, &LightPubSubC__packet);
      LightPubSubC__Timer1__startOneShot(3 * 300);
    }
}
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void LightPubSubC__Timer2__startOneShot(uint32_t dt){
#line 73
  /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__startOneShot(3U, dt);
#line 73
}
#line 73
inline static void LightPubSubC__Timer3__startOneShot(uint32_t dt){
#line 73
...
#line 98
{
  ...
  if (LightPubSubC__connectAcked == TRUE) {
      printf("Node %d is already connected, sending a subscription request\n", TOS_NODE_ID);
      LightPubSubC__Timer3__startOneShot(8000);
      return;
    }
  else 
#line 106
    {
      pub_sub_msg_t *msg = (pub_sub_msg_t *)LightPubSubC__Packet__getPayload(&LightPubSubC__packet, sizeof(pub_sub_msg_t ));

#line 108
      printf("Node %d is not connected, sending a connection request\n", TOS_NODE_ID);
      __nesc_hton_uint8(msg->type.nxdata, CONN);
      __nesc_hton_uint16(msg->sender.nxdata, TOS_NODE_ID);
      LightPubSubC__generate_send(1, &LightPubSubC__packet);
      LightPubSubC__Timer2__startOneShot(8000);
    }
}

# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t LightPubSubC__Random__rand16(void ){
#line 52
  unsigned int __nesc_result;
#line 52
...
#line 119
{
  ...
  if (LightPubSubC__subscribeAcked == TRUE) {
...
#line 128
          __nesc_hton_uint8(msg->type.nxdata, PUB);
          __nesc_hton_uint16(msg->sender.nxdata, TOS_NODE_ID);
          __nesc_hton_uint8(msg->topic.nxdata, LightPubSubC__Random__rand16() % 3);
          __nesc_hton_uint16(msg->payload.nxdata, LightPubSubC__Random__rand16() % 100);
          LightPubSubC__generate_send(1, &LightPubSubC__packet);
        }
      return;
    }
...
#line 137
      ...
      __nesc_hton_uint8(msg->type.nxdata, SUB);
      __nesc_hton_uint16(msg->sender.nxdata, TOS_NODE_ID);
      __nesc_hton_uint8(msg->topic.nxdata, LightPubSubC__Random__rand16() % 3);
      LightPubSubC__generate_send(1, &LightPubSubC__packet);
      LightPubSubC__Timer3__startOneShot(8000);
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0xb6ff49f0){
#line 83
  switch (arg_0xb6ff49f0) {
#line 83
    case 1U:
#line 83
      LightPubSubC__Timer0__fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      LightPubSubC__Timer1__fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      LightPubSubC__Timer2__fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      LightPubSubC__Timer3__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0xb6ff49f0);
#line 83
      break;
#line 83
    }
...
# 92 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static bool LightPubSubC__Timer0__isRunning(void ){
#line 92
  unsigned char __nesc_result;
#line 92
...
#line 92
#line 73
inline static void LightPubSubC__Timer0__startOneShot(uint32_t dt){
#line 73
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0xb6efd088, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0xb6efd088, msg, payload, len);
#line 78
...
#line 282
  for (i = 0; i < 20; i++) {
      if (__nesc_ntoh_uint8(client_list[i].is_subscribed.nxdata) == TRUE && __nesc_ntoh_uint8(client_list[i].topic.nxdata) == __nesc_ntoh_uint8(msg.topic.nxdata)) {
          pub_sub_msg_t *payload = (pub_sub_msg_t *)LightPubSubC__Packet__getPayload(&LightPubSubC__packet, sizeof(pub_sub_msg_t ));

#line 285
          *payload = msg;
          LightPubSubC__add_message(&LightPubSubC__message_list, *payload, i + 1);
        }
    }
}
...
{
  if (TOS_NODE_ID == 1) {
      printf("Received publish request from client %d, on topic %d with payload %d\n", __nesc_ntoh_uint16(msg->sender.nxdata), __nesc_ntoh_uint8(msg->topic.nxdata), __nesc_ntoh_uint16(msg->payload.nxdata));
      printf(" Adding messages for clients subscribed to topic %d\n", __nesc_ntoh_uint8(msg->topic.nxdata));
      LightPubSubC__addClientMatchingTopic(LightPubSubC__client_list, *msg);
    }
  else 
#line 274
    {
...
#line 261
{
  ...
  LightPubSubC__subscribeAcked = TRUE;
}
...
#line 243
{
  ...
  printf("Received subscription request from client %d, on topic %d\n", __nesc_ntoh_uint16(msg->sender.nxdata), __nesc_ntoh_uint8(msg->topic.nxdata));
  if (__nesc_ntoh_uint8(LightPubSubC__client_list[__nesc_ntoh_uint16(msg->sender.nxdata) - 1].is_connected.nxdata) == FALSE) {
...
#line 251
    {
      pub_sub_msg_t *ack = (pub_sub_msg_t *)LightPubSubC__Packet__getPayload(&LightPubSubC__packet, sizeof(pub_sub_msg_t ));

#line 253
      printf(" Client is connected, sending subscription ack\n");
      __nesc_hton_uint8(LightPubSubC__client_list[__nesc_ntoh_uint16(msg->sender.nxdata) - 1].is_subscribed.nxdata, TRUE);
      __nesc_hton_uint8(LightPubSubC__client_list[__nesc_ntoh_uint16(msg->sender.nxdata) - 1].topic.nxdata, __nesc_ntoh_uint8(msg->topic.nxdata));
      __nesc_hton_uint8(ack->type.nxdata, SUBACK);
      LightPubSubC__add_message(&LightPubSubC__message_list, *ack, __nesc_ntoh_uint16(msg->sender.nxdata));
    }
}
...
#line 235
{
  ...
  LightPubSubC__connectAcked = TRUE;
}
...
#line 228
      printf("Received connection request from client %d, sending connection ack\n", __nesc_ntoh_uint16(msg->sender.nxdata));
      __nesc_hton_uint8(LightPubSubC__client_list[__nesc_ntoh_uint16(msg->sender.nxdata) - 1].is_connected.nxdata, TRUE);
      __nesc_hton_uint8(ack->type.nxdata, CONNACK);
      LightPubSubC__add_message(&LightPubSubC__message_list, *ack, __nesc_ntoh_uint16(msg->sender.nxdata));
    }
}
...
#line 212
      switch (__nesc_ntoh_uint8(msg->type.nxdata)) {
          case CONN: LightPubSubC__handleConnect(msg);
#line 213
          break;
          case CONNACK: LightPubSubC__handleConnectAck(msg);
#line 214
          break;
          case SUB: LightPubSubC__handleSubscribe(msg);
#line 215
          break;
          case SUBACK: LightPubSubC__handleSubscribeAck(msg);
#line 216
          break;
          case PUB: LightPubSubC__handlePublish(msg);
#line 217
          break;
        }
      return bufPtr;
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0xb6eff9d0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb6eff9d0) {
#line 78
    case 6:
#line 78
      __nesc_result = LightPubSubC__Receive__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0xb6eff9d0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0xb73a8b78){
#line 102
  switch (arg_0xb73a8b78) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0xb73a8b78);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0xb7290e78){
#line 102
  switch (arg_0xb7290e78) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 102
    default:
#line 102
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0xb7290e78);
#line 102
      break;
#line 102
    }
...
# 82 "/opt/tinyos-main-2.1.2/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0xb73a3710, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 82
  switch (arg_0xb73a3710) {
#line 82
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 82
...
#line 82
    default:
#line 82
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0xb73a3710, txBuf, rxBuf, len, error);
#line 82
      break;
#line 82
    }
...
# 71 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0xb743bb38, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0xb743bb38) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0xb743bb38, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0xb6efb148, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0xb6efb148, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-main-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0xb743bb38, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0xb743bb38) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0xb743bb38, data, length, error);
#line 91
      break;
#line 91
    }
...
# 102 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0xb743b108){
#line 102
  switch (arg_0xb743b108) {
#line 102
...
#line 102
    default:
#line 102
      CC2420SpiP__Resource__default__granted(arg_0xb743b108);
#line 102
      break;
#line 102
    }
...
#line 100
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0xb6eff010, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0xb6eff010, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
...
#line 138
  LightPubSubC__AMControl__stopDone(error);
#line 138
}
#line 138
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t LightPubSubC__AMControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 200
  for (i = 0; i < 20; i++) {
      __nesc_hton_uint8(LightPubSubC__client_list[i].topic.nxdata, -1);
      __nesc_hton_uint8(LightPubSubC__client_list[i].is_subscribed.nxdata, FALSE);
      __nesc_hton_uint8(LightPubSubC__client_list[i].is_connected.nxdata, FALSE);
    }
}
...
{
  if (err == SUCCESS) {
      LightPubSubC__locked = FALSE;
      if (TOS_NODE_ID == 1) {
          printf("PAN Coordinator ActiveMessageControl Started!\n", TOS_NODE_ID);
          LightPubSubC__initClientList();
          LightPubSubC__Timer1__startOneShot(300);
        }
      else {
          printf("Node %d ActiveMessageControl Started!\n", TOS_NODE_ID);
          LightPubSubC__connectAcked = FALSE;
          LightPubSubC__subscribeAcked = FALSE;
          LightPubSubC__Timer2__startOneShot(8000);
        }
    }
  else 
#line 182
    {
      LightPubSubC__AMControl__start();
    }
}
...
#line 113
  LightPubSubC__AMControl__startDone(error);
#line 113
}
#line 113
# 120 "/opt/tinyos-main-2.1.2/tos/interfaces/Resource.nc"
...
# 54 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0xb72b3758, uint8_t data){
#line 54
  switch (arg_0xb72b3758) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0xb72b3758, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0xb72b2010){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0xb72b2010);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0xb72b3758){
#line 49
  switch (arg_0xb72b3758) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0xb72b3758);
#line 49
      break;
#line 49
    }
...
# 79 "/opt/tinyos-main-2.1.2/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0xb6e21b70, uint8_t byte){
#line 79
  switch (arg_0xb6e21b70) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0xb6e21b70, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0xb6e21b70, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0xb6e21b70) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0xb6e21b70, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0xb72b3758, uint8_t data){
#line 54
  switch (arg_0xb72b3758) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0xb72b3758, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0xb6e21b70, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0xb6e21b70) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0xb6e21b70, buf, len, error);
#line 57
      break;
#line 57
    }
...
# 49 "/opt/tinyos-main-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0xb72b3758){
#line 49
  switch (arg_0xb72b3758) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0xb72b3758);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-main-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0xb7937b30){
#line 39
  switch (arg_0xb7937b30) {
#line 39
    case 0:
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0xb7937b30);
#line 39
      break;
#line 39
    }
...
#line 189
{
  if (&LightPubSubC__queued_packet == bufPtr && error == SUCCESS) {
      LightPubSubC__locked = FALSE;
    }
  else {
...
#line 63
{
  if (LightPubSubC__Timer0__isRunning() == TRUE) {
      return FALSE;
    }
  LightPubSubC__queued_packet = *msg;
  LightPubSubC__queued_address = address;
  LightPubSubC__Timer0__startOneShot(300);
  return TRUE;
}
...
#line 295
{
  LightPubSubC__message_list_t *new_message = (LightPubSubC__message_list_t *)malloc(sizeof(LightPubSubC__message_list_t ));
